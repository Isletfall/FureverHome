...
public class ChatController {
    ...
    public Result<java.util.Map<String, Object>> wsInfo() {
        ...
        java.util.Map<String, Object> newMsg = new java.util.HashMap<>();
        newMsg.put("type", "new_message");
        java.util.Map<String, Object> newMsgData = new java.util.HashMap<>();
        newMsgData.put("messageId", 1);
        newMsgData.put("conversationId", 1);
        newMsgData.put("senderId", 1);
        newMsgData.put("senderName", "alice");
        newMsgData.put("senderAvatar", "https://example.com/avatar.png");
        newMsgData.put("content", "你好");
        newMsgData.put("messageType", "text");
        newMsgData.put("createdAt", "2025-12-01T12:00:00");
        newMsg.put("data", newMsgData);
        java.util.Map<String, Object> typing = new java.util.HashMap<>();
        typing.put("type", "typing");
        java.util.Map<String, Object> typingData = new java.util.HashMap<>();
        typingData.put("conversationId", 1);
        typingData.put("fromUserId", 2);
        typingData.put("action", "start");
        typing.put("data", typingData);
        java.util.Map<String, Object> read = new java.util.HashMap<>();
        read.put("type", "read");
        java.util.Map<String, Object> readData = new java.util.HashMap<>();
        readData.put("conversationId", 1);
        readData.put("readerId", 2);
        readData.put("lastReadMessageId", 99);
        read.put("data", readData);
        java.util.Map<String, Object> unread = new java.util.HashMap<>();
        unread.put("type", "unread_count");
        java.util.Map<String, Object> unreadData = new java.util.HashMap<>();
        unreadData.put("totalUnread", 5);
        unread.put("data", unreadData);
        java.util.Map<String, Object> examples = new java.util.HashMap<>();
        examples.put("new_message", newMsg);
        examples.put("typing", typing);
        examples.put("read", read);
        examples.put("unread_count", unread);
        info.put("receiveExamples", examples);
